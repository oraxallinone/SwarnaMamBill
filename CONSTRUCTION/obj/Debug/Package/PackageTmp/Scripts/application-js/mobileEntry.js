$(document).ready(function () {
    //#start on page load load content
    const d = new Date();
    ...
    //// When Enter is pressed in Expense textbox
    //$("#expense").on("keydown", function (e) {
    //    debugger
    //    if (e.key === "Enter") {
    //        debugger
    //        e.preventDefault(); // stop default form submission
    //         // move cursor to details textbox
    //    }
    //});

    //// When Enter is pressed in Details textbox
    //$("#details").on("keydown", function (e) {
    //    if (e.key === "Enter") {
    //        e.preventDefault();
    //        saveExpensiveData();
    //    }
